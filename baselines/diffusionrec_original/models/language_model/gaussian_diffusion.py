...
class GaussianDiffusion:
    ...
    def training_losses_seq2seq(self, model, t, word_features, model_kwargs=None, noise=None):
        """
        ...
        model_output = model.language_trans(x_t, self._scale_timesteps(t))
