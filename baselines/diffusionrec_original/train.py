...
def get_args_parser():
    ...
    parser.add_argument('--bert_model', default='./checkpoints/sup-bert', type=str, help='bert model')
    ...
    parser.add_argument('--disable_channel', action='store_true',
                        help="If true, use amp training")
    parser.add_argument('--swin_checkpoint', default='checkpoints/unc_latest.pth',type=str)
    return parser
